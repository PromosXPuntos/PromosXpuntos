...
class UserSpec extends Specification {
    ...
    def "Testing Domain Class User - name"() {
        when:
        def t_User_name = new User(name: name,  email: 'jorge@hotmail.com', nickname: 'testingnick', password: 'okokokok', picture: 'noproblemmm')
...
/**
    ...
    def "Testing Domain Class User - email"() {
        when:
        def t_User_email = new User(name: 'TESTNAME', email: email, nickname: 'testingnick', password: 'okokokok', picture: 'noproblemmm')
    ...
    def "Testing Domain Class User - nickname"() {
        when:
        def t_User_nickname = new User(name: 'TESTNAME', email: 'jorge@hotmail.com', nickname: nickname, password: 'okokokok', picture: 'noproblemmm')
    ...
    def "Testing Domain Class User - password"() {
        when:
        def t_User_password = new User(name: 'TESTNAME', email: 'jorge@hotmail.com', nickname: 'testingnick', password: password, picture: 'noproblemmm')
    ...
    def "Testing Domain Class User - picture"(){
        when:
        def t_User_picture = new User(name: 'TESTNAME',email: 'jorge@hotmail.com',nickname: 'testingnick',password: 'okokokok',picture: picture)
